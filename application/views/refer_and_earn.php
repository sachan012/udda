                ...
                <div class="bg-white spinWin-container container ">
                    <div class="row">
                        <div class="col-md-5 colL text-center">
                            <img src="<?php echo base_url();?>assets/images/external/Refer-Earn.png" class="img-fluid">
                        </div>
                        <div class="col-md-7 colR text-center pt-4">
                            <div class="referDiv">
                                <p class="mb-0 blue-color">REFER A FRIEND</p>
                                <p class="mb-0 bolder-dark">Earn</p>
                                <p class="mb-0">5,000 FREE UDDA Bucks</p>
                            </div>
                            <div class="rewardDiv blue-color">
                                <p class="mb-0">You will receive</p>
                                <p class="mb-0"><span class="bolder">5,000 UDDA</span> Bucks</p>
                            </div>
